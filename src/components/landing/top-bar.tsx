...
export function TopBar() {
    return (
        <div className="w-full bg-[#F4F1EC] text-[#1a4d45] text-xs py-2 px-4 border-b border-[#1a4d45]/10">
            <div className="container mx-auto flex justify-between items-center font-medium">

                {/* Left: Social Icons (Hidden on mobile) */}
                <div className="hidden md:flex items-center gap-5">
                    <a href="https://www.instagram.com/idmisk.ma/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110 duration-200">
                        <Instagram className="h-3.5 w-3.5" />
                        <span className="sr-only">Instagram</span>
                    </a>
                    {/* YouTube removed as per previous request */}

                    <a href="https://www.tiktok.com/@idmisk7" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110 duration-200">
                    ...
                    <a href="https://www.pinterest.com/idmisk/_profile/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110 duration-200">
                        {/* Pinterest Icon SVG */}
                ...
                <div className="flex-1 text-center">
                    <span className="font-medium tracking-wide">📦 Livraison Gratuite partout au Maroc !</span>
                </div>
